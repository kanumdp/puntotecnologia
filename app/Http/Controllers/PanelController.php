...
class PanelController extends Controller
{
    ...
    public function catalogo()
	    {	
	    	...
	    	//return dd($productos);
	    	return view('panel.products.catalogo')->with('marcas', $marcas)->with('img_productos', $img_productos)->with('productos', $productos)->with('lista_categorias', $lista_categorias);
	    }
